            ...
            <div className="footer-wrapper-due-studio">
                <div className="footer-left-due-studio">
                    ...
                    <ul className="footer-social-list-due-studio">
                        <li className="footer-social-item-due-studio"><a href="https://api.whatsapp.com/send?phone=5541991256464&text=Ol%C3%A1,%20vim%20pelo%20seu%20site!%20Gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20uma%20futura%20aula%20experimental." id="btn-footer-whatsapp"><Image src="/icon-whatsapp.svg" alt="Ícone WhatsApp" width={46} height={46} /></a></li>
